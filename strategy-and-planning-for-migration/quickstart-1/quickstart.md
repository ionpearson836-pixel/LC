...
metaLinks:
  alternates:
    - /broken/spaces/EwOn3si2UOVRL65zVOMg/pages/sdPCBIM0Va5hRFhASzre
---

# What to Prepare Before You Purchase a Migration Service
...
<summary><strong>Do I need to choose a target platform before I start?</strong></summary>

It helps, but it is not always required. You can still clarify scope, complexity, and validation priorities first. Once the target is confirmed, mapping decisions become more concrete.

</details>

<details>

<summary><strong>Do I need to prepare a full data export first?</strong></summary>

Not necessarily. You mainly need clarity on what data exists, where complexity lives, and what must be validated. A demo-level proof point is often more useful than a large export file.

</details>

<details>

<summary><strong>Is “Demo Migration” useful if I already know my catalog is large?</strong></summary>

Yes. Size is not the main risk. Structure is. A demo helps confirm how variants, categories, and key relationships will be represented on the target cart.
